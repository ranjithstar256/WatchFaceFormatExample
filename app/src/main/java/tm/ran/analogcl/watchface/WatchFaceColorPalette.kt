 ...
 */
package tm.ran.analogcl.watchface
 ...
 * [tm.ran.analogcl.watchface.ColorStyleIdAndResourceIds] constant ids to actual resources with context at run time.
 *
...
data class WatchFaceColorPalette(
    ...
    companion object {
        /**
         * Converts [tm.ran.analogcl.watchface.ColorStyleIdAndResourceIds] to [WatchFaceColorPalette].
         */
