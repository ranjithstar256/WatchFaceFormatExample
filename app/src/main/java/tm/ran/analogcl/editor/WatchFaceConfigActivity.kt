 ...
 */
package tm.ran.analogcl.editor
...
import tm.ran.analogcl.editor.WatchFaceConfigStateHolder.Companion.MINUTE_HAND_LENGTH_DEFAULT_FOR_SLIDER
import tm.ran.analogcl.editor.WatchFaceConfigStateHolder.Companion.MINUTE_HAND_LENGTH_MAXIMUM_FOR_SLIDER
import tm.ran.analogcl.editor.WatchFaceConfigStateHolder.Companion.MINUTE_HAND_LENGTH_MINIMUM_FOR_SLIDER
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import tm.ran.analogcl.watchface.ColorStyleIdAndResourceIds
import tm.ran.analogcl.utils.LEFT_COMPLICATION_ID
import tm.ran.analogcl.utils.RIGHT_COMPLICATION_ID
import tm.ran.analogcl.databinding.ActivityWatchFaceConfigBinding

/**
 * Allows user to edit certain parts of the watch face (color style, ticks displayed, minute arm
 * length) by using the [tm.ran.analogcl.editor.WatchFaceConfigStateHolder]. (All widgets are disabled until data is
 * loaded.)
 */
