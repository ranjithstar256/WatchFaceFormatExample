...
import tm.ran.analogcl.watchface.WatchFaceColorPalette.Companion.convertToWatchFaceColorPalette
import tm.ran.analogcl.watchface.WatchFaceData
            ...
            when (options.key.id.toString()) {
                COLOR_STYLE_SETTING -> {
                    ...
                    newWatchFaceData = newWatchFaceData.copy(
                        activeColorStyle = ColorStyleIdAndResourceIds.Companion.getColorStyleConfig(
