...
import tm.ran.analogcl.watchface.DRAW_HOUR_PIPS_DEFAULT
...
fun createUserStyleSchema(context: Context): UserStyleSchema {
    ...
    val colorStyleSetting =
        UserStyleSetting.ListUserStyleSetting(
            ...
            null,
            ColorStyleIdAndResourceIds.Companion.toOptionList(context),
            listOf(
                WatchFaceLayer.BASE,
